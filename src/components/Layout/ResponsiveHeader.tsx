...
const ResponsiveHeader: React.FC<ResponsiveHeaderProps> = ({ currentPage, onPageChange }) => {
  ...
  const allModules = [
    ...
    { key: 'history', label: 'Hist. Movim.', icon: History, page: 'movements' },
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
      <div className="flex items-center space-x-4">
          ...
          <SheetContent side="left" className="w-64">
            <div className="flex flex-col h-full">
              <div className="py-4 border-b">
                ...
                {/* Status de conexão no menu mobile */}
                <div className="mt-2">
                  <ConnectionStatus />
                </div>
              </div>
        ...
        {/* Status de conexão no desktop - posição central */}
      ...
      <div className="flex items-center space-x-4">
        {/* Status de conexão no mobile - lado direito */}
